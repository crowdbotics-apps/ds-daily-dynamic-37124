...
## Project Structure
    ...
    ├── ds_daily_dynamic_37124  # Django project configurations
...
1. Clone this repo and `cd ds_daily_dynamic_37124`
...
2. Clone this repo and `cd ds_daily_dynamic_37124`
